...
import { ArrowLeft, ArrowRight, ArrowUpRight, Play, Volume2 } from 'lucide-react';
...
export default function Home() {
    ...
    return (
        <div className="w-full bg-white font-outfit">
            {/* Hero Section */}
            <section className="relative w-full max-w-container mx-auto h-[600px] md:h-[900px] overflow-hidden -mt-[80px] md:-mt-[132px]">
                {/* Background Image */}
                <img
                    src={heroBackground}
                    alt="Hero Background"
                ...
                <div className="absolute inset-0 flex items-end justify-center pb-12 md:pb-24 z-10 transition-transform duration-1000">
                    <img
                        src={deityImage}
                        alt="Deity"
                        className="h-[450px] md:h-[750px] w-auto object-contain drop-shadow-[0_25px_60px_rgba(0,0,0,0.6)]"
                    />
                </div>

                {/* Professional Bottom Gradient - Seamless transition */}
                <div
                    className="absolute bottom-0 left-0 right-0 h-[200px] md:h-[400px] z-20 pointer-events-none"
                    style={{
            ...
            <section className="w-full bg-[#E8F7FF] overflow-hidden">
                <div className="max-w-container mx-auto py-10 md:pt-[60px] md:pb-[100px] px-4 md:px-[100px] flex flex-col items-center gap-8 md:gap-[60px]">
                    {/* Text Container */}
                    ...
                    <div className="w-full max-w-[1240px] flex flex-col items-center gap-[20px]">
                        {/* Inside Container */}
                        <div className="flex flex-col items-center gap-[10px] pb-[18px] w-full max-w-[763px]">
                            <img
                                src={dailyDarshanImg}
                                alt="Daily Darshan"
                                className="object-cover w-full h-auto aspect-[763/1252] rounded-[12px] md:rounded-[18px]"
                            />
                            <p className="font-katibeh font-[400] text-[28px] md:text-[40px] leading-[32px] text-[#005382] text-center capitalize mt-2">
                                Daily Darshan
                            </p>
                        </div>
                    </div>
                ...
                <div className="w-full max-w-container mx-auto px-8 flex flex-col items-center">
                    ...
                    <div className="flex items-center justify-center gap-8 w-full max-w-[1300px]">
                        ...
                        <button
                            ...
                            className="hidden md:flex w-12 h-12 shrink-0 rounded-full border border-[#005382] items-center justify-center text-[#005382] hover:bg-[#005382] hover:text-white transition-colors"
                        >
                            <ArrowLeft size={24} />
                        </button>
                        ...
                        <div
                            ...
                            className="flex gap-4 md:gap-8 overflow-x-auto py-4 px-4 md:px-2 scroll-smooth snap-x snap-mandatory"
                            style={{
                                scrollbarWidth: 'none',
                            ...
                            {[1, 2, 3].map((set) => (
                                <React.Fragment key={set}>
                                    {[
                                        ...
                                        <div
                                            key={`${set}-${index}`}
                                            className="flex flex-col shrink-0 bg-white min-w-[85vw] md:min-w-[370px] snap-center h-auto md:h-[349px]"
                                            style={{
                                                borderRadius: '36px',
                                        ...
                                        >
                                            {/* Image Container */}
                                            <div className="w-full overflow-hidden rounded-t-[36px] h-[200px] md:h-[262px]">
                                                <img
            ...
            <section className="w-full bg-[#E8F7FF] overflow-hidden">
                <div className="max-w-container mx-auto px-4 md:px-[100px] pb-[100px] pt-[20px] flex flex-col items-center gap-[60px]">
                    ...
                    <div className="w-full flex flex-col lg:flex-row justify-center gap-10 lg:gap-[96px]">
                        {/* Left Column (Images) */}
                        <div className="flex flex-col gap-[24px] w-full lg:w-[431px]">
                            {[
                                ...
                                <div
                                    key={i}
                                    className="flex flex-col items-center bg-white group w-full"
                                    style={{
                                        borderRadius: '18px',
                                ...
                                >
                                    <div
                                        className="overflow-hidden w-full h-auto aspect-[391/218]"
                                        style={{
                                            borderRadius: '12px'
                                        }}
                                    >
                                    ...
                                    <h3 className="font-katibeh text-[28px] md:text-[32px] leading-[32px] text-[#038972] text-center">
                                        {item.title}
                                    </h3>
                                </div>
                            ))}
                        ...
                        {/* Divider */}
                        <div
                            className="bg-[#038972] hidden lg:block"
                            style={{
                                width: '2px',
                                height: '652px',
                                opacity: 1
                        ...
                        <div className="flex flex-col gap-[8px] w-full lg:w-[488px]">
                            {[1, 2, 3, 4, 5].map((i) => (
                                <div
                                    key={i}
                                ...
                                >
                                    <div className="w-full flex flex-col justify-between h-full gap-2">
                                        <div className="flex justify-between items-start w-full">
                                            <span className={`font-medium text-[16px] md:text-[18px] leading-[24px] ${i === 1 ? 'text-white' : 'text-[#038972] group-hover:text-white'}`}>
                                                Global Events
                                            </span>
                                            <ArrowUpRight
                                                size={20}
            ...
            {/* PHOTO & VIDEO Section */}
            <section className="w-full bg-[#E8F7FF] overflow-hidden">
                <div className="max-w-container mx-auto px-4 md:px-[100px] py-[60px] md:py-[100px] flex flex-col items-center gap-[60px]">
                    {/* Title */}
                    <SectionTitle title="PHOTO & VIDEO" color="#C65300" />

                    {/* Cards Container */}
                    <div className="flex justify-center flex-wrap gap-8 md:gap-[50px] w-full max-w-[1186px]">
                        {[
                            ...
                            <div key={index} className="flex flex-col items-center gap-[20px] w-full max-w-[362px]">
                                <h3 className="font-katibeh font-[400] text-[32px] md:text-[40px] leading-[32px] text-[#C65300] text-center uppercase tracking-[0.06em]">
                                    {item.type}
                                </h3>

                                {/* Card Box */}
                                <div
                                    className="bg-white flex flex-col items-center transition-transform hover:-translate-y-1 w-full h-auto"
                                    style={{
                                        gap: '22px',
                                        borderRadius: '18px',
                                        padding: '20px',
                                ...
                                >
                                    <img
                                        src={upcomingEventImg}
                                        alt={item.title}
                                        className="object-cover w-full h-auto aspect-[285/216] rounded-[12px]"
                                    />
                                    ...
                                    <button
                                        className="flex items-center justify-center transition-colors text-[#C65300] hover:bg-[#C65300] hover:text-white w-full h-[48px] mt-4"
                                        style={{
                                            borderRadius: '67px',
            ...
            >
                <div className="max-w-container mx-auto flex flex-col items-center gap-[80px]">
                    ...
                    <div className="relative w-full flex items-center">
                        ...
                        <button
                            className="hidden md:flex absolute left-[8%] z-30 w-14 h-14 rounded-full border-2 border-[#005382] items-center justify-center text-[#005382] bg-white hover:bg-[#005382] hover:text-white transition-all shadow-lg"
                        ...
                        <div
                            ...
                            className="flex gap-[60px] md:gap-[120px] overflow-x-auto py-10 px-4 md:px-[237px] scroll-smooth no-scrollbar w-full items-center snap-x snap-mandatory"
                            style={{
                                scrollbarWidth: 'none',
                                msOverflowStyle: 'none'
                            }}
                            ...
                            {[1, 2, 3].map((set) => (
                                <React.Fragment key={set}>
                                    {[1, 2, 3, 4, 5].map((_, index) => (
                                        <div
                                            key={`${set}-${index}`}
                                            className="shrink-0 relative group transition-all duration-700 snap-center w-[90vw] h-[250px] md:w-[966px] md:h-[477px]"
                                        >
                        ...
                        <button
                            className="hidden md:flex absolute right-[8%] z-30 w-14 h-14 rounded-full border-2 border-[#005382] items-center justify-center text-[#005382] bg-white hover:bg-[#005382] hover:text-white transition-all shadow-lg"
            ...
            <section
                className="w-full py-[60px] md:py-[100px] relative overflow-hidden"
                style={{
                    background: 'linear-gradient(180deg, #E8F7FF 0%, #FFF5F5 15%, #FFF5F5 85%, #E8F7FF 100%)'
                }}
            >
                <div className="max-w-container mx-auto px-4 md:px-[100px] flex flex-col items-center gap-[60px]">
                    ...
                    {/* Cards Container */}
                    <div className="flex justify-center flex-wrap gap-8 md:gap-[40px] w-full max-w-[1240px]">
                        {[
                            ...
                            <div key={index} className="relative group w-full md:max-w-[600px] h-auto md:h-[302.12px]">
                                {/* Accent Background (Thick Green Shadow) */}
                                <div
                                    className="absolute inset-0 bg-[#038972] translate-y-[6px] translate-x-[6px] md:translate-y-[8.8px] md:translate-x-[8.8px]"
                                    style={{ borderRadius: '52.85px' }}
                                />

                                {/* Main Card Content */}
                                <div
                                    className="relative w-full h-full bg-white flex flex-col md:flex-row overflow-hidden transition-all duration-500 ease-out"
                                    style={{
                                        borderRadius: '52.85px',
                                    }}
                                >
                                    {/* Left Image Component */}
                                    <div className="w-full h-[200px] md:w-[48%] md:h-full flex items-center justify-center md:-translate-x-[2px] overflow-hidden">
                                        <SatsangUpdateImage
                                            src={dailyDarshanImg}
                                            className="w-full h-full object-cover"
                                        />
                                    ...
                                    <div
                                        className="flex flex-col justify-center p-6 md:pl-4 md:pr-10 gap-4 md:gap-[16px] w-full md:w-[312px]"
                                    >
                                        {/* Title Block */}
                                        <div className="flex flex-col gap-1 items-start">
                                            <h3
                                                className="font-katibeh text-[32px] md:text-[40px] leading-none text-[#038972]"
                                            >
                                                {item.title}
                                            </h3>
                                            <div
                                        ...
                                        {/* Description Text */}
                                        <p
                                            className="text-[#57534E] text-[16px] md:text-[18px] leading-[24px] line-clamp-3"
                                            style={{
                                                fontFamily: 'Outfit, sans-serif',
                                        ...
                                        {/* View More Button */}
                                        <button
                                            className="flex items-center justify-center text-white font-bold transition-all active:scale-95 mt-2 md:mt-0"
                                            style={{
                                                width: '94px',
                                                height: '40px',
                                                borderRadius: '8px',
            ...
            <section className="w-full bg-[#E8F7FF] overflow-hidden">
                <div className="max-w-container mx-auto py-[100px] flex flex-col items-center gap-[80px]">
                    ...
                    <div className="relative w-full flex items-center justify-center">
                        {/* Left Arrow */}
                        <button
                            className="hidden md:flex absolute left-[20px] lg:left-[40px] z-30 w-14 h-14 rounded-full border-2 border-[#C65300] items-center justify-center text-[#C65300] bg-white/80 backdrop-blur-sm hover:bg-[#C65300] hover:text-white transition-all shadow-lg active:scale-90"
                        ...
                        <div
                            ref={babjiSliderRef}
                            className="flex gap-[12px] overflow-x-auto py-10 px-4 md:py-20 md:px-[calc(50%-210px)] scroll-smooth no-scrollbar w-full items-center snap-x snap-mandatory"
                            style={{
                                scrollbarWidth: 'none',
                                msOverflowStyle: 'none'
                            }}
                            onScroll={(e) => {
                                ...
                                // Only run 3D effect logic on larger screens if desired, or adjust calculations for mobile
                            ...
                            {[1, 2, 3].map((set) => (
                                <React.Fragment key={set}>
                                    {[1, 2, 3, 4, 5, 6, 7].map((_, index) => (
                                        <div
                                            key={`${set}-${index}`}
                                            className="shrink-0 relative group snap-center flex items-center justify-center transition-all duration-300 w-[80vw] h-[400px] md:w-[420px] md:h-[500px]"
                                        >
                                            ...
                                            <div
                                                ...
                                                style={{
                                                    ...
                                                    overflow: 'hidden',
                                                    // Remove inline transform scale for mobile to avoid conflict, relying on 3D effect script or default
                                                }}
                                            >
                                                <img
                                                    src={upcomingEventImg}
                        ...
                        {/* Right Arrow */}
                        <button
                            className="hidden md:flex absolute right-[20px] lg:right-[40px] z-30 w-14 h-14 rounded-full border-2 border-[#C65300] items-center justify-center text-[#C65300] bg-white/80 backdrop-blur-sm hover:bg-[#C65300] hover:text-white transition-all shadow-lg active:scale-90"
            ...
            >
                <div className="max-w-container mx-auto flex flex-col items-center gap-[60px] md:gap-[80px]">
                    {/* Title */}
                    ...
                    <div className="relative w-full flex items-center justify-center">
                        {/* Left Arrow */}
                        <button
                            className="hidden md:flex absolute left-[20px] lg:left-[40px] z-30 w-14 h-14 rounded-full border-2 border-[#005382] items-center justify-center text-[#005382] bg-white/80 backdrop-blur-sm hover:bg-[#005382] hover:text-white transition-all shadow-lg active:scale-90"
                        ...
                        <div
                            ...
                            className="flex gap-[20px] md:gap-[40px] overflow-x-auto py-10 px-4 md:py-20 md:px-[calc(50%-210px)] scroll-smooth no-scrollbar w-full items-center snap-x snap-mandatory"
                            style={{
                                scrollbarWidth: 'none',
                                msOverflowStyle: 'none'
                            }}
                            ...
                            {[1, 2, 3].map((set) => (
                                <React.Fragment key={set}>
                                    {[
                                        ...
                                        <div
                                            key={`${set}-${index}`}
                                            className="shrink-0 relative group snap-center flex flex-col items-center justify-center transition-all duration-300 w-[80vw] h-[500px] md:w-[420px] md:h-[650px]"
                                        >
                                            {/* The actual card content */}
                                            <div
                                                className="w-full h-full relative transition-all duration-500 origin-center flex flex-col items-center"
                                                style={{
                                                    // Mobile default opacity/scale can be handled here or via the scroll script
                                                }}
                                            >
                                                ...
                                                {/* Name Typography */}
                                                <h3
                                                    className="mt-6 font-serif text-[24px] md:text-[28px] font-bold text-[#005382] text-center"
                        ...
                        {/* Right Arrow */}
                        <button
                            className="hidden md:flex absolute right-[20px] lg:right-[40px] z-30 w-14 h-14 rounded-full border-2 border-[#005382] items-center justify-center text-[#005382] bg-white/80 backdrop-blur-sm hover:bg-[#005382] hover:text-white transition-all shadow-lg active:scale-90"
            ...
            {/* GALLERY Section */}
            <section className="w-full bg-[#E8F7FF] overflow-hidden">
                <div className="max-w-container mx-auto px-4 py-[60px] md:py-[100px] flex flex-col items-center gap-[40px] md:gap-[60px]">
                    {/* Title */}
                    <SectionTitle title="Gallery" color="#038972" />

                    {/* Categories Grid Container */}
                    <div
                        className="flex flex-col md:flex-row justify-between items-center w-full max-w-[1240px] mx-auto gap-8 md:gap-0 h-auto md:h-[388.93px]"
                    >
                        {[
                            {
                                label: "IMAGE",
                            ...
                            <div key={index} className="flex flex-col items-center gap-6 group cursor-pointer transition-transform duration-300 hover:-translate-y-2">
                                {/* Hexagon Container */}
                                <div
                                    className="relative flex items-center justify-center p-2 scale-[0.85] md:scale-100"
                                    style={{
                                        width: '386px',
                                        height: '335px',
                                    }}
                                ...
                                {/* Label */}
                                <h3 className="font-katibeh text-[32px] md:text-[40px] leading-none text-[#038972] tracking-[0.05em] uppercase">
                                    {category.label}
                                </h3>
                            </div>
                        ))}
