...
export default function Home() {
    ...
    const scroll = (direction: 'left' | 'right') => {
        if (scrollContainerRef.current) {
            const scrollAmount = 400; // specific width + gap
                    ...
                    <div className="flex items-center justify-center gap-8 w-full max-w-[1300px]">
                        ...
                        >
                            {[
                                ...
                                // Added more items to demonstrate scrolling capability if user duplicated items or had more
            ...
            <section className="w-full max-w-[1440px] mx-auto px-[100px] pb-[100px] pt-[20px] flex flex-col items-center gap-[60px]">
                ...
                <div className="w-full flex justify-center gap-[96px]">
                    ...
                    <div className="flex flex-col gap-[8px]" style={{ width: '488px' }}>
                        {[1, 2, 3, 4].map((i) => (
                            <div
                                key={i}
                                className="group relative cursor-pointer transition-all duration-300 bg-white hover:bg-[#038972] border border-[#038972]"
                                style={{
                                    width: '488px',
                                    height: '124px',
                                    borderRadius: '20px',
                            ...
                            >
                                <div className="w-full flex flex-col justify-between h-full">
                                    <div className="flex justify-between items-start w-full">
                                        <span className="font-medium text-[18px] leading-[24px] text-[#038972] group-hover:text-white">
                                            Global Events
                                        </span>
                                        <ArrowUpRight
                                            size={20}
                                            className="text-[#038972] group-hover:text-white"
                                        />
                                    </div>

                                    <div className="flex flex-col gap-1">
                                        <p className="font-normal text-[14px] leading-[20px] text-[#555555] group-hover:text-white line-clamp-2">
                                            SMVS Swaminarayan Mandir Satellite 8th Patotsav | HDH Swamishri Vicharan
                                        </p>
                                        <p className="font-normal text-[14px] leading-[20px] text-[#555555] group-hover:text-white/80">
                                            17 Oct, 2024
                                        </p>
                                    </div>
                                </div>
                ...
                <button
                    ...
                    style={{
                        ...
                        fontFamily: 'Outfit, sans-serif' // ensuring font matches if needed, though global is set
                    }}
                >
                    View More
                </button>
            ...
            <section className="w-full max-w-[1440px] mx-auto py-[100px] flex flex-col items-center gap-[80px] overflow-hidden">
                ...
                <div className="relative w-full flex items-center">
                    ...
                    <button
                        ...
                        onClick={() => {
                            const container = document.getElementById('satsang-slider');
                            if (container) container.scrollBy({ left: -1086, behavior: 'smooth' });
                        }}
                    >
                        <ArrowLeft size={28} />
                    </button>
                    ...
                    >
                        {[1, 2, 3, 4, 5].map((_, index) => (
                            ...
                            >
                                {/* We can use a CSS-based approach to dim side cards if we add intersection observer, 
                                    but for now, let's ensure the peeking is correct. To add "cutout" and dimming, 
                                    we can add an overlay that fades out on non-focused elements if we had state. 
                                    Let's use a simpler approach: the side ones are just there. */}
            ...
            <section className="w-full max-w-[1440px] mx-auto py-[100px] flex flex-col items-center gap-[80px] overflow-hidden">
                ...
                <div className="relative w-full flex items-center justify-center">
                    ...
                    <button
                        ...
                        onClick={() => {
                            const container = document.getElementById('babji-slider');
                            if (container) {
                                container.scrollBy({ left: -431, behavior: 'smooth' });
                            }
                        }}
                    >
                        <ArrowLeft size={28} />
                    ...
                    <script dangerouslySetInnerHTML={{
                        __html: `
                        // Initialize first item as active on mount
                        setTimeout(() => {
                            const slider = document.getElementById('babji-slider');
                            if (slider) slider.dispatchEvent(new Event('scroll'));
                        }, 100);
                    `}} />
                </div>
            </section>
            ...
            <section className="w-full max-w-[1440px] mx-auto py-[100px] flex flex-col items-center gap-[80px] overflow-hidden">
                ...
                <div className="relative w-full flex items-center justify-center">
                    ...
                    <button
                        ...
                        onClick={() => {
                            const container = document.getElementById('founder-slider');
                            if (container) container.scrollBy({ left: -431, behavior: 'smooth' });
                        }}
                    >
                        <ArrowLeft size={28} />
                    </button>
                    ...
                    <script dangerouslySetInnerHTML={{
                        ...
                        // Initialize first item as active on mount
                        setTimeout(() => {
                            const slider = document.getElementById('founder-slider');
                            if (slider) slider.dispatchEvent(new Event('scroll'));
                        }, 100);
                    `}} />
                </div>
